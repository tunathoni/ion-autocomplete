...
(function() {
    ...
    angular.module('ion-autocomplete', []).directive('ionAutocomplete', [
        '$ionicBackdrop', '$ionicPopup', '$ionicScrollDelegate', '$document', '$q', '$parse', '$interpolate', '$ionicPlatform', '$compile', '$templateRequest',
        function ($ionicBackdrop, $ionicPopup, $ionicScrollDelegate, $document, $q, $parse, $interpolate, $ionicPlatform, $compile, $templateRequest) {
            return {
                ...
                controller: ['$attrs', '$timeout', '$scope', function ($attrs, $timeout, $scope) {
                    ...
                    $timeout(function () {
                        ...
                        controller.selectItemsLabel = valueOrDefault(controller.selectItemsLabel, "Available Player...");
                        controller.selectedItemsLabel = valueOrDefault(controller.selectedItemsLabel, $interpolate("Selected player{{maxSelectedItems ? ' (max. ' + maxSelectedItems + ')' : ''}}:")(controller));
                ...
                link: function (scope, element, attrs, controllers) {
                    ...
                    $q.when().then(function () {
                        ...
                        ionAutocompleteController.selectItem = function (item) {
                            // check if disabled item is true or false
